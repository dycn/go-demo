...
var file_demo_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x1d, 0x0a, 0x07,
	...
	,
...
var file_demo_proto_depIdxs = []int32{
	0, // 0: StreamService.Eat:input_type -> Request
	0, // 1: StreamService.Work:input_type -> Request
	0, // 2: StreamService.Sleep:input_type -> Request
	1, // 3: StreamService.Eat:output_type -> Response
	1, // 4: StreamService.Work:output_type -> Response
	1, // 5: StreamService.Sleep:output_type -> Response
...
type StreamServiceClient interface {
	Eat(ctx context.Context, in *Request, opts ...grpc.CallOption) (StreamService_EatClient, error)
...
func (c *streamServiceClient) Eat(ctx context.Context, in *Request, opts ...grpc.CallOption) (StreamService_EatClient, error) {
	stream, err := c.cc.NewStream(ctx, &_StreamService_serviceDesc.Streams[0], "/StreamService/Eat", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamServiceEatClient) Recv() (*Response, error) {
	m := new(Response)
...
func (c *streamServiceClient) Work(ctx context.Context, opts ...grpc.CallOption) (StreamService_WorkClient, error) {
	stream, err := c.cc.NewStream(ctx, &_StreamService_serviceDesc.Streams[1], "/StreamService/Work", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamServiceWorkClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServiceWorkClient) CloseAndRecv() (*Response, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(Response)
...
func (c *streamServiceClient) Sleep(ctx context.Context, opts ...grpc.CallOption) (StreamService_SleepClient, error) {
	stream, err := c.cc.NewStream(ctx, &_StreamService_serviceDesc.Streams[2], "/StreamService/Sleep", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamServiceSleepClient) Send(m *Request) error {
	return x.ClientStream.SendMsg(m)
}

func (x *streamServiceSleepClient) Recv() (*Response, error) {
	m := new(Response)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type StreamServiceServer interface {
	Eat(*Request, StreamService_EatServer) error
...
func (*UnimplementedStreamServiceServer) Eat(*Request, StreamService_EatServer) error {
	return status.Errorf(codes.Unimplemented, "method Eat not implemented")
}
func (*UnimplementedStreamServiceServer) Work(StreamService_WorkServer) error {
	return status.Errorf(codes.Unimplemented, "method Work not implemented")
}
func (*UnimplementedStreamServiceServer) Sleep(StreamService_SleepServer) error {
...
func (x *streamServiceEatServer) Send(m *Response) error {
...
func (x *streamServiceWorkServer) SendAndClose(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServiceWorkServer) Recv() (*Request, error) {
	m := new(Request)
...
func (x *streamServiceSleepServer) Send(m *Response) error {
	return x.ServerStream.SendMsg(m)
}

func (x *streamServiceSleepServer) Recv() (*Request, error) {
	m := new(Request)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
